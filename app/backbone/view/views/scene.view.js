...
var SceneView = Backbone.View.extend({
    ...
    set_events: function() {
        ...
        // vent.on("open-animation", this.open, this)
        // vent.on("close-animation", this.close, this)
        // vent.on("open-close-animation", this.open_close, this)
        vent.on("scene:change-cloth", this.change_cloth, this)
        vent.on("ar:start", this.start_ar, this)
        // vent.on("change-cloth", this.change_cloth, this)
    },
        ...
        return new Promise((resolve, reject) => {
            ...
            loader.load(
                ...
                (text) => {
                    ...
                    // vent.trigger("progress:loading", 1)
                    resolve(true)
                },
                (xhr) => {
