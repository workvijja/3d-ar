...
const increase_texture_form = () => {
    ...
    delete_button.on("click", {counter: counter}, decrease_texture_form)
}
add_button.on("click", increase_texture_form)