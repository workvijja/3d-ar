var APP = {
	...
	Player: function () {
		...
		function animate(timestamp, frame) {
			...
			// console.log(camera.position.toArray(), target_object.position.toArray())
			...
			try {
				...
				animations.update()
				// animations.update(time - prevTime)
		...
		function onSelect() {
			if (reticle.visible) {
				// target_object.position.setFromMatrixPosition(reticle.matrix);
				...
				// console.log("scale sekarang", target_object.scale.toArray())
				target_object.visible = true
				selected = true
			}
		}
